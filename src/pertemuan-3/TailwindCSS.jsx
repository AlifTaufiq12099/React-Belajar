export default function Tailwindcss() {
    ...
    function spacing() {
        return (
            <div className="bg-white shadow-lg p-6 m-4 rounded-lg">
                ...
                <p className="mt-2 text-grey-600">ini adalah contoh penffunaan padding dalam margin di tailwind </p>
            </div>
        )
    }
    function Typography() {
    ...
    function BorderRadius() {
        return (
            <button className="m-3 border-3 border-blue-500 text-blue-500 px-4 py-3 rounded-lg hover:shadow-2xl transition"> Klik Saya </button>
        )
    }
    function BackgroundColors() {
        return (
            <div className="bg-blue-500 text-white p-6 m-3 rounded-lg shadow-lg">
    ...
    return (
        <nav className="m-3 flex justify-between bg-gray-800 p-4 text-white">
