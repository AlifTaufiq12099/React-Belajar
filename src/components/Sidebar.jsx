    ...
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-logo" className="flex flex-col" >
                <span id="logo-title" className="font-extrabold text-[48px] text-gray-900">
            ...
            <div id="sidebar-menu" className="mt-10">
                <ul id="menu-list" className="mt-10">
                    <li>
                        <NavLink
                        id="menu-1" 
                        to="/"
                    ...
                    <li>
                        ...
                        className={menuClass}
                        >   
                        <FaCartArrowDown className="mr-3 text-xl"/>  
                        <span>Orders</span> 
                        </NavLink>
                    </li>
            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card" className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center">
                    ...
                    <img id="footer-avatar"className="w-20 rounded-full" src="https://img.pikbest.com/png-images/20241030/female-chef-icon-with-red-and-white-colors_11027828.png!sw800" />
                </div>
